  ...
  return (
    ...
    <div className="player__controls">
        ...
        <div className="song-item">
            <div className="song-item__wrap">
                <div
                    className="song-item__name-wrap song-item__name-wrap_type_current"
                >
            ...
            <div className="song-item__timeline">
                ...
                <div className="song-item__timeline-hover-playhead" data-content="1:00"></div>
            </div>
        </div>
    ...
    <div className="player__details-container">
        ...
        <ul className="details__songs-list">
            <li className="details__song-item">
                ...
                Петров
                    ...
                    ><span
                        className="song-item__detail song-item__detail_type_author"
                        >Мукулатура feat. Саша Петров</span
                    > */}
                </a>
            </li>
            <li className="details__song-item">
                <a href="#" className="song-item__name-wrap song-item__name-wrap_type_release">Поезия &mdash; Мукулатура feat. Саша
                    Петров
                    {/* <span
                                            className="song-item__detail song-item__detail_type_number"
                                            >&#8470;6</span
            ...
            </li><li className="details__song-item">
                <a href="#" className="song-item__name-wrap song-item__name-wrap_type_release">Поезия &mdash; Мукулатура feat. Саша
                    Петров
                    {/* <span
                                            className="song-item__detail song-item__detail_type_number"
        ...
        <p className="details__song-text">
            Мой милый милый мальчик<br />
            Моя милая милая девочка<br />
            Никогда не знаешь что будет дальше<br />
            В этой гадкой зиме
        </p>
    </div>
</div>
